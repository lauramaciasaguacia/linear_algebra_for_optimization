...
newker = lap - ev_max * scipy.sparse.identity(lap.shape[0], format="csr")  # make the smallest eigenvalues have the largest absolute value
...
for i in range(NumberOfClusters):
    ...
    print(np.outer(v, v))
    newker = newker - mu * scipy.sparse.csr_matrix(np.outer(v, v))
